...
public ServiceHebergement() {
    ...
    public void modifier(Hebergement hebergement) throws SQLException {
        ...
        String sql = "UPDATE hebergement SET nom = ?, telephone = ?, capacite = ?, adresse = ?, email = ?, tarif_nuit = ?, image_url = ? WHERE id_hebergement = ?";
        ...
        ps.setString(7, hebergement.getPhotoUrl());  // This should be the image URL, not the photo URL
        ps.setInt(8, hebergement.getId_hebergement()); // Last parameter is the ID
