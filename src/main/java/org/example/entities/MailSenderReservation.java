...
public class MailSenderReservation {
    public static void sendMail(String mail) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "																							TO\n"
                + "																							MEDTRAVEL</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                ...
                + "																				for booking our service.</span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                ...
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>Details:<br> Company name : "+"MEDTRAVEL"+"</span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                ...
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			MEDTRAVEL © -  Your favorite company tool.\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			Tunis, Tunisia.</p>\n"
                ...
                + "																					:\n"
                + "																					MEDTRAVEL@gmail.com</strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
                ...
                + "\n"
                + "</html>";
        String myAccountEmail = "beyaabid876@gmail.com";
        String password = "khojfavmfkhgzdbq";
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient , String mailContent) {
        try {
            ...
            message.setSubject("Welcome to MEDTRAVELMailSender");
