...
public class planning_docService implements IService<planning_doc>{
    ...
    public List<planning_doc> retrieve() throws SQLException{
    ...
    public void add(planning_doc p) throws SQLException
    {
    ...
    public void update(int id,planning_doc p) throws SQLException{
