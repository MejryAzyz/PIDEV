...
public class updateControllerResp {
    ...
    private planning selectedItem;

    private displayController displayController;
    private Controllers.displayRespController displayRespController;

    public void setDisplayController(displayController displayController) {
        this.displayController = displayController;
    }

    public void setDisplayRespController(displayRespController displayRespController) {
        this.displayRespController = displayRespController;
    }

    public void setSelectedItem(planning selectedItem) {
        this.selectedItem = selectedItem;
    }

    public planning getSelectedItem()
    {
        return selectedItem;
    }
