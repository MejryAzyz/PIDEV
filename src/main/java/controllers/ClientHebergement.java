...
public class ClientHebergement {
    ...
    private void afficherDetailsHebergement(Hebergement hebergement) {
        try {
            ...
            Stage currentStage = (Stage) hebergementContainer.getScene().getWindow();
            Scene newScene = new Scene(root);
            currentStage.setScene(newScene);
            currentStage.setTitle("Accommodation Details");

            // Optionally preserve the original size
            currentStage.setWidth(hebergementContainer.getScene().getWidth());
            currentStage.setHeight(hebergementContainer.getScene().getHeight());
