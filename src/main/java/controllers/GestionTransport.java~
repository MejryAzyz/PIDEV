...
public class GestionTransport implements Initializable {
    ...
    private void handleModifyButton(Transport transport) {
        // Implement the modify action, e.g., opening a dialog to edit the transport details
        System.out.println("Modify transport: " + transport.getId_transport());
