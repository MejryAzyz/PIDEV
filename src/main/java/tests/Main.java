...
public class Main {
    public static void main(String[] args) {
        ...
        Clinique c = new Clinique(3,"C1","27 Nile Corniche, Zamalek, Cairo, Égypte","+81 3 1234 5678","C1@gmail.com","Clinique moderne au Caire, offrant une gamme complète de soins médicaux et un service client exceptionnel.", 7800);
